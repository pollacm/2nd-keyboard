...
else if (foobar = "anchor_point_vertical" || foobar = "position_vertical")
{
	...
	;MouseMove, xxx+50, yyy
	;msgbox, first point

	;MouseMove, xxx+800, yyy+500
	;msgbox, second point
	
	ImageSearch, Px, Py, xxx+50, yyy, xxx+800, yyy+500, *3 %A_WorkingDir%\anti-flicker-filter_000_D2019_ui100.png ;for a user interface at 100%...
	;the *3 allows some minor variation in the searched image.
	if ErrorLevel = 1
		ImageSearch, Px, Py, xxx+50, yyy, xxx+800, yyy+500, *3 %A_WorkingDir%\anti-flicker-filter_000_D2019_2.png
}
...
if ErrorLevel
	...
	{
		;msgbox, 4 point
		MouseMove, Px+80, Py-200
		;msgbox,,,, about to move,0.5
		MouseMove, Px+80, Py-200, 0 ;relative to the unrelated 0.00 text (which I've never changed,) this moves the cursor onto the SECOND variable for the anchor point... the VERTICAL number, rather than horizontal.
		;tooltip, where am I?
		;msgbox, where am i
		;sleep 1000
	}
